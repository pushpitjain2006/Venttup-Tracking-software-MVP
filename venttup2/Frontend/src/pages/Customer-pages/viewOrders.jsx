      ...
      <div className="max-w-4xl w-full p-6 bg-white bg-opacity-90 rounded-lg shadow-lg">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          {loading ? (
            ...
            <p className="text-center text-red-600 font-medium">Error fetching orders.</p>
            ...
            orders.map((order, index) => (
              ...
              >
                ...
                <p><span className="font-medium">Requirement:</span> {order.orderType}</p>
                <p><span className="font-medium">Sector:</span> {order.sector}</p>
                <p><span className="font-medium">Comments:</span> {order.comments || "N/A"}</p>
                <p><span className="font-medium">Price:</span> ₹{order.totalAmount}</p>
                <p><span className="font-medium">Status:</span> {order.currentStatus}</p>
