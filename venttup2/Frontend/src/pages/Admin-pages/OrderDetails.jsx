          ...
          (
            <div className="w-full mx-auto bg-slate-600 shadow-lg p-8 text-gray-100">
              ...
              <div className="flex justify-end items-center">
                <button
                  className="m-4 focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
